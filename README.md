...
```bash
wget -c https://github.com/greenforce-project/greenforce_clang/releases/download/09032024/greenforce-clang-19.0.0-09032024-0240.tar.zst -O - | tar --use-compress-program=unzstd -xf - -C ~/toolchains/greenforce-clang
